...
PRODUCT_PRODUCT_PROPERTIES += \
    ...
    persist.scandium.display.refresh_rate=90 \
    persist.scandium.display.touch_boost_ms=500 \
    persist.scandium.sched.autogroup=1 \
    persist.scandium.kernel.printk_level=3 \
    persist.scandium.irq.balance=true \
    persist.scandium.irq.rfs=true \
    persist.scandium.fs.f2fs_gc=true \
    persist.scandium.thermal.threshold=42 \
