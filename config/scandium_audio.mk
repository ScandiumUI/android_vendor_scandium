#
# ScandiumUI Audio Files
#

ALARM_PATH := vendor/scandium/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/scandium/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/scandium/prebuilt/common/media/audio/ringtones
